...
const Profile = () => {
  const { myDetails, myDetailsError, myDetailsIsLoading, getMyDetails } = useContext(UserContext);
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          {/* <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="drop-shadow-2">
              <img className='w-full h-full object-cover' src={`http://localhost:4000${myDetails?.profilePicture}`} alt="profile" />
            </div>
          </div> */}
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3 overflow-hidden">
            <div className="drop-shadow-2 w-full h-full">
              <img
                className="w-full h-full object-cover"
                src={`http://localhost:4000${myDetails?.profilePicture}`}
                alt="profile"
              />
            </div>
          </div>
          ...
          <div className="mt-4">
            ...
            <p className="font-medium">{myDetails?.email}</p>
            <p className="font-normal py-2">{myDetails?.phoneNumber}</p>
