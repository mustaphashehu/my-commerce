...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#0d4e78] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
        }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <li>
                      <NavLink
                        to="/"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#07345b] dark:hover:bg-meta-4 ${pathname === '/' && 'bg-[#07345b] dark:bg-meta-4'
                          }`}
                      >
                        <svg
                          className="fill-current"
              ...
              {user && user.role === "business" ?
                <li>
                  <NavLink
                    to="/my-products"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#07345b] dark:hover:bg-[#07345b] ${pathname.includes('my-products') &&
                      'bg-[#07345b] dark:bg-meta-4'
                      }`}
                  >
                    <svg
                      className="fill-current"
              ...
              {/* <!-- Menu Item Profile --> */}
              {
                user ?
                  <li>
                    <NavLink
                      to="/profile"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#07345b] dark:hover:bg-[#07345b] ${pathname.includes('profile') && 'bg-[#07345b] dark:bg-meta-4'
                        }`}
                    >
                      <svg
                        className="fill-current"
...

              {
                user && user.role === "business" ?
                  <li>
                    <NavLink
                      to="/create-product"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#07345b] dark:hover:bg-[#07345b] ${pathname.includes("create-product") && "bg-[#07345b] dark:bg-meta-4"
                        }`}
                    >
                      <svg
                        className="fill-current"
                    ...
                    <NavLink
                      to="/ordered-products"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#07345b] dark:hover:bg-[#07345b] ${pathname.includes("ordered-products") && "bg-[#07345b] dark:bg-meta-4"
                        }`}
                    >
                      <svg
                        className="fill-current"
...

              {
                user && user.role === "customer" ?
                  <li>
                    <NavLink
                      to="/cart"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#07345b] dark:hover:bg-[#07345b] ${pathname.includes("cart") && "bg-[#07345b] dark:bg-meta-4"
                        }`}
                    >
                      <svg
                        className="fill-current"
                    ...
                    <NavLink
                      to="/complaint-form"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#07345b] dark:hover:bg-[#07345b] ${pathname.includes("complaint-form") && "bg-[#07345b] dark:bg-meta-4"
                        }`}
                    >
                      <BiCommentError className="text-lg" /> {/* Complaint Icon */}
                      Submit Complaint
                    </NavLink>

                    {/* <NavLink
                      to="/complaint-form"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("complaint-form") && "bg-graydark dark:bg-meta-4"
                        }`}
                    >
                      <svg
                        className="fill-current"
              ...
              {/* <!-- Menu Item Forms --> */}
              {
                user && user.role === "admin" ?
                  <li>
                    <NavLink
                      to="/admin/users"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#07345b] dark:hover:bg-[#07345b] ${pathname.includes('users') && 'bg-[#07345b] dark:bg-meta-4'
                        }`}
                    >
                      <svg
                        className="fill-current"
                    ...
                    <NavLink
                      to="/admin/complaints"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#07345b] dark:bg-[#07345b] ${pathname.includes("/admin/complaints") && "bg-[#07345b] dark:bg-meta-4"
                        }`}
                    >
                      <BiCommentError className="text-lg" /> {/* Complaint Icon */}
                      Complains
                    ...
                    {/* <NavLink
                      to="/admin/complaints"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('/admin/complaints') && 'bg-graydark dark:bg-meta-4'
                        }`}
                    >
                      <svg
                        className="fill-current"
              ...
              {/* <!-- Menu Item Settings --> */}
              {
                user ?
                  <li>
                    <NavLink
                      to="/settings"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#07345b] dark:hover:bg-meta-4 ${pathname.includes('settings') &&
                        'bg-[#07345b] dark:bg-meta-4'
                        }`}
                    >
                      <svg
                    ...
                    {(handleClick, open) => {
                      return (
                        <React.Fragment>
                          <NavLink
                            to="#"
                            className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#07345b] dark:hover:bg-[#07345b] ${(pathname === '/auth' || pathname.includes('auth')) &&
                              'bg-[#07345b] dark:bg-meta-4'
                              }`}
                            onClick={(e) => {
                              e.preventDefault();
